...
const FeaturedSection = () => {
  return (
    <section className="content-grid relative z-20 bg-primary-900">
      <div className="full-width content-grid rounded-tr-[2rem] bg-white lg:rounded-t-[2rem]">
        <div className="flex justify-between gap-12 pb-8 pt-14 max-lg:flex-col lg:items-center">
