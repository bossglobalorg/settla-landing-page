...
const RealTimeUpdateSection = () => {
  ...
  return (
    <section className="content-grid overflow-hidden bg-primary-900 py-[3.75rem] text-white max-lg:pb-28">
      <div className="flex items-center justify-between max-lg:flex-col-reverse max-lg:gap-6">
        ...
        <div className="w-full max-w-[30rem]">
          <h2 className="text-2xl font-semibold leading-8 max-md:max-w-96 md:text-h2 md:font-medium md:leading-[4rem] md:tracking-[-0.125rem]">
